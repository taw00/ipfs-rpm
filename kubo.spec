...
%changelog
* Wed Apr 29 2026 Todd Warner <t0dd_at_protonmail.com> 0.41.0-1.rp.taw
* Wed Apr 29 2026 Todd Warner <t0dd_at_protonmail.com> 0.41.0-0.1.testing.rp.taw
  - repackaged binary build - https://github.com/ipfs/kudo/releases/tag/v0.41.0

* Mon Mar 9 2026 Todd Warner <t0dd_at_protonmail.com> 0.40.1-1.rp.taw
* Mon Mar 9 2026 Todd Warner <t0dd_at_protonmail.com> 0.40.1-0.1.testing.rp.taw
  - repackaged binary build - https://github.com/ipfs/kudo/releases/tag/v0.40.1

* Sat Nov 29 2025 Todd Warner <t0dd_at_protonmail.com> 0.39.0-1.rp.taw
* Sat Nov 29 2025 Todd Warner <t0dd_at_protonmail.com> 0.39.0-0.1.testing.rp.taw
...
* Wed Oct 22 2025 Todd Warner <t0dd_at_protonmail.com> 0.38.1-1.rp.taw
* Wed Oct 22 2025 Todd Warner <t0dd_at_protonmail.com> 0.38.1-0.1.testing.rp.taw
  - repackaged binary build - https://github.com/ipfs/kudo/releases/tag/v0.38.1

* Mon Oct 6 2025 Todd Warner <t0dd_at_protonmail.com> 0.38.0-1.rp.taw
* Mon Oct 6 2025 Todd Warner <t0dd_at_protonmail.com> 0.38.0-0.1.testing.rp.taw
  - repackaged binary build - https://github.com/ipfs/kudo/releases/tag/v0.38.0

* Mon Sep 15 2025 Todd Warner <t0dd_at_protonmail.com> 0.37.0-1.rp.taw
* Mon Sep 15 2025 Todd Warner <t0dd_at_protonmail.com> 0.37.0-0.1.testing.rp.taw
  - repackaged binary build - https://github.com/ipfs/kudo/releases/tag/v0.37.0
...
* Mon May 26 2025 Todd Warner <t0dd_at_protonmail.com> 0.35.0-0.1.testing.rp.taw
  ...
  - I think it is safe to finally stop calling this a test release.

* Mon Apr 7 2025 Todd Warner <t0dd_at_protonmail.com> 0.34.1-0.1.testing.rp.taw
  - repackaged binary build - https://github.com/ipfs/kudo/releases/tag/v0.34.1
...
* Sun Feb 16 2025 Todd Warner <t0dd_at_protonmail.com> 0.33.2-0.1.testing.rp.taw
  ...
  - repackaged binary build - https://github.com/ipfs/kudo/releases/tag/v0.33.0
  - repackaged binary build - https://github.com/ipfs/kudo/releases/tag/v0.32.1
